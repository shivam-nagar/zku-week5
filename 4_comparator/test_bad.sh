...
cd bad_force_equal_if_enabled;
node generate_witness.js bad_force_equal_if_enabled.wasm ../input.json ../witness.wtns
cd ..
#
snarkjs groth16 setup bad_force_equal_if_enabled.r1cs ../powersOfTau28_hez_final_16.ptau key_0000.zkey
echo "test" | snarkjs zkey contribute key_0000.zkey key_final.zkey --name="1st Contributor Name" -v
snarkjs zkey verify bad_force_equal_if_enabled.r1cs ../powersOfTau28_hez_final_16.ptau key_final.zkey
